...
func _process(delta):
	...
	# a Ball toca as laterais esq e dir e renicia a partida.  (E marca gol [nao implementado] )
	...
	# Criar rect2 envolta dos para controles de bordas
	...
	# Ball recebe valores autualizados
